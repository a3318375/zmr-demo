package com.zmr.gateway.service.impl;

import com.google.code.kaptcha.Producer;
import com.zmr.common.core.constant.CacheConstants;
import com.zmr.common.core.constant.Constants;
...
import com.zmr.common.core.utils.uuid.IdUtils;
import com.zmr.common.core.web.domain.AjaxResult;
import com.zmr.common.redis.service.RedisService;
import com.zmr.gateway.config.properties.CaptchaProperties;
import com.zmr.gateway.service.ValidateCodeService;
...
public class ValidateCodeServiceImpl implements ValidateCodeService {
    ...
    public AjaxResult createCaptcha() throws IOException, CaptchaException {
        ...
        ajax.put("uuid", uuid);
        ajax.put("img", SecureUtil.base64Encode(os.toByteArray()));
        return ajax;
    }
